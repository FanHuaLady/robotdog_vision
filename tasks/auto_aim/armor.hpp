...
struct Armor
{
  ...
  Eigen::Vector3d xyz_in_gimbal;                          // 云台坐标系下的3D位置单位：m
  Eigen::Vector3d xyz_in_world;                           // 世界坐标系下的3D位置单位：m
